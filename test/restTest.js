...
describe('RESTful API tests #1', function() {
  ...
  it('The request to update data should return status 202', function(done) {
	...
	addedGroup.save(function(err) {
	  ...
	  updatedGroup.name = 'Updated API Group';
	  updatedGroup.acronym = 'UG';
	  updatedGroup.acronym = undefined;
	  updatedGroup.restrictedAttr = undefined;
  ...
  it('The request to patch data should return status 202', function(done) {
	var Group = models['Group'];
	...
	addedGroup.save(function(err) {
	  ...
	  supertest(app)
	  .patch('/data/Group/' + addedGroup.id)
	  .send(updatedGroup)
	  .expect(202)
	  .end(function(err, res) {
